...
if (isset($_POST['login'])) {
    $email = $_POST['email']; //$_POST data tidak terlihat di URL
    $password = sha1($_POST['password']); //sha1 untuk password
...
body{
    ...
    opacity: 0.8;
    background-image: radial-gradient(#a1a6ff 1.3px, #ffffff 1.3px);
...
<div class="container">
    ...
    <div class="container">
        ...
        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            Designed by <a href="#">Riyan Laundry</a>
            </div>
